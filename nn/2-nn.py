...
# Here there's no direct correlation between input and output
# so we introduce one extra hidden layer
# only a combination of 1,2 cols of l0 have effect in output. since col3 is always 1
